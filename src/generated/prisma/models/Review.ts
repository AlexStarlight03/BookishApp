...
export type ReviewOrderByWithRelationInput = {
  ...
  full_review?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type ReviewOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idReview" | "idUser" | "idBook" | "rating" | "full_review" | "createdAt", ExtArgs["result"]["review"]>
...
export interface ReviewDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Reviews and only return the `idReview`
   * const reviewWithIdReviewOnly = await prisma.review.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Reviews and only return the `idReview`
   * const reviewWithIdReviewOnly = await prisma.review.updateManyAndReturn({
   *   select: { idReview: true },
   *   where: {
   *     // ... provide filter here
   *   },
